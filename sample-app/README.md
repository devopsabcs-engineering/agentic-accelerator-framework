...
> [!CAUTION]
> This application contains **intentional vulnerabilities, accessibility violations, code quality issues, and cost governance gaps** for testing Accelerator Framework agents. **Never deploy this application to production.**
